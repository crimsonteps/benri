<p align="center">
  <img src="Resources/benri-icon-source.png" width="128" height="128" alt="Benri 应用图标">
</p>
...
<p align="center">
  ...
  ·
  <a href="https://github.com/crimsonteps/quick-vault/releases/latest">下载</a>
  ·
  <a href="https://github.com/crimsonteps/quick-vault/issues">反馈问题</a>
</p>
...
1. 从 [Releases](https://github.com/crimsonteps/quick-vault/releases/latest) 下载最新的 `Benri-vX.Y.Z-macOS-universal.zip`。
...
安全问题请使用 [GitHub 私密安全报告](https://github.com/crimsonteps/quick-vault/security/advisories/new)，不要提交公开 Issue。详见 [SECURITY.md](SECURITY.md)。
